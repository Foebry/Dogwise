const WebsiteIcon: React.FC<React.HTMLProps<SVGSVGElement>> = ({ width = 24 }) => (
  <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" height={width} width={width} xmlns="http://www.w3.org/2000/svg">
