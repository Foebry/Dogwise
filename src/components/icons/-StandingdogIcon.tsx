const StandingdogIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ width = 24 }) => (
  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" height={width} width={width} xmlns="http://www.w3.org/2000/svg">
    <title>Standing Dog Icon</title>
...
export default StandingdogIcon;
