const HouseIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ width = 24 }) => (
  <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width={width} height={width} viewBox="0 0 64 64">
